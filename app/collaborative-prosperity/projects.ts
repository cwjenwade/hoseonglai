...
export type ResearchProject = ContentGovernanceFields & {
  ...
  /** Deprecated: retained for historical in-app assessment flow. */
  testUrl: string;
...
// Deprecated: retained for historical in-app assessment records and legacy admin views.
export function getResearchProjectTestUrl(projectId: string): string {
  return `/collaborative-prosperity/tests/${projectId}`;
}

export function getResearchProjectGoogleFormUrl(
  project: Pick<ResearchProject, "googleFormUrl">,
): string {
  return String(project.googleFormUrl || "").trim();
}

// Deprecated: retained for historical assessment API compatibility.
...
export function normalizeResearchProject(
  ...
  const googleFormUrl = String(project.googleFormUrl || "").trim();
  const testUrl =
...
export const RESEARCH_PROJECTS: ResearchProject[] = [
  {
    ...
    participationDetails: "閱讀研究說明後，透過研究專屬 Google Form 完成參與資料填寫，約 12–15 分鐘。",
  ...
  },
  {
    ...
    principalInvestigator: "Ho-Se 好勢｜Ong-Lai 旺來 研究團隊",
    researchContact: "Ho-Se 好勢｜Ong-Lai 旺來 研究聯絡窗口",
    participationDetails: "閱讀研究說明後，透過研究專屬 Google Form 完成參與資料填寫，約 10–12 分鐘。",
    researchAudiencePurpose:
  ...
  },
  {
    ...
    principalInvestigator: "Ho-Se 好勢｜Ong-Lai 旺來 研究團隊",
    researchContact: "Ho-Se 好勢｜Ong-Lai 旺來 研究聯絡窗口",
    participationDetails: "閱讀研究說明後，透過研究專屬 Google Form 完成參與資料填寫，約 15–18 分鐘。",
    researchAudiencePurpose:
